...
2. From the MDRUN module, the execution of simulations with the _ORCA_ and _GROMACS_ programs is carried out using the 
   ...
   * For examples, visit the [MDRUN](https://github.com/otaviolsantana/solvate/blob/main/tutorials/modules/3_MDRUN.md) and DATAS tutorials page. (under construction...)
   ...
   « [Previous topic](https://github.com/otaviolsantana/solvate/blob/main/guide/stages/1st_Stage.md) | [GUIDE](https://github.com/otaviolsantana/solvate/tree/main/guide) | [Next topic](https://github.com/otaviolsantana/solvate/blob/main/guide/stages/3rd_Stage.md) »
